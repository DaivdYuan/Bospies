...
import myPosts from "../json/my_posts.json";

const MyPostsLayout = (props) => {
  const [allPosts, setAllPosts] = React.useState(myPosts);
  const [posts, setPosts] = React.useState(myPosts);
  ...
  return (
    <div>
      <NavBar title="My Posts" post="true"/>

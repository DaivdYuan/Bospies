  ...
  return (
    <PostBox justifyContent="flex-end">
      ...
      {isHomepage ?
        <>
          {post.images.length === 0 ?
            <Typography sx={{ fontSize: "18px", color: "#33363F", fontWeight: 400, textOverflow: "ellipsis", overflow: "hidden", display: "-webkit-box", WebkitLineClamp: 4, WebkitBoxOrient: "vertical" }} textAlign="left">
              {post.body}
            </Typography>
            :
            <Grid container justifyContent="space-between">
              <Grid item xs={8} sx={{paddingRight: "20px"}}>
                <Typography sx={{ fontSize: "18px", color: "#33363F", fontWeight: 400, textOverflow: "ellipsis", overflow: "hidden", display: "-webkit-box", WebkitLineClamp: 5, WebkitBoxOrient: "vertical" }} textAlign="left">
                  {post.body}
                </Typography>
              </Grid>
              <Grid item xs={4}>
                <div style={{position: "relative"}}>
                  ...
                  <div style={{position: "absolute", bottom: "10px", right: "10px", backgroundColor: '#F5F5F5', width: "28px", height: "28px", borderRadius: 4, display: "flex", justifyContent: 'center', alignItems: "center", fontWeight: 600 }}>
                    +{post.images.length - 1}
                  </div>
                  }
                </div>
      ...
      <Grid container justifyContent="flex-end" sx={{ marginTop: "12px" }}>
        <ButtonBase>
          <AddIcon sx={{ color: "#33363F", stroke: "#33363F", marginRight: "4px" }} />
